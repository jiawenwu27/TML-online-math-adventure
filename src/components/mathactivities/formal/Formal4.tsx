...
export default function Formal4({
  onBack,
  onComplete,
  answers: propAnswers,
  ...
  const questions = [
    { question: "368 - 127 = ?", correctAnswer: 241 },
    { question: "253 - 164 + 65 = ?", correctAnswer: 154 },
    { question: "122 - 45 + 152 = ?", correctAnswer: 229 },
  ];
